...
public final class ExternalRecipeBuilder {
    ...
    public static JsonArray conditions(String modId) {
        ...
        conditions.add(condition("neoforge:mod_loaded", "modid", modId));
        return conditions;
    }
    ...
    public static JsonObject stack(String id, int count) {
        JsonObject json = new JsonObject();
