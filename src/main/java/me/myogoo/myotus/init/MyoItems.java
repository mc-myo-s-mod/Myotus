...
public class MyoItems {
    ...
    public static final DeferredItem<DiamondUpgradeCardItem> DIAMOND_UPGRADE_CARD =
            ITEMS.register("diamond_upgrade_card", () -> new DiamondUpgradeCardItem(new Item.Properties().stacksTo(1)));
}
